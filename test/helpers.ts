...
export async function resetDatabase(): Promise<void> {
  await pool.query(
    'truncate table event, grant_edge, resource_capability, resource, principal, rba_export_state, chain_checkpoint, rba_export_dead_letter restart identity cascade',
  );
}
